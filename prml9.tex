...
$$
E_Z[\log p(X,Z)|\mu,\vpi)]=\sum_{n,k} \gamma(z_{nk}) A.
$$
$$
...
F &=& E[\log p(t,w|\alpha,\beta)]\\
 &=& E[\sum_n (\frac{1}{2} \log (\frac{\beta}{2\pi})
...
$\alpha$に関する最大化
$$
\diff{\alpha}F=\frac{M}{2}\frac{1}{\alpha}-\frac{1}{2}E[\inp{w}]=0.
$$
よって
$$
...
$\beta$に関する最大化
$$
\diff{\beta}F=\frac{N}{2}\frac{1}{\beta}-\frac{1}{2}\sum_n E[(t_n-\trans{w}\phi_n)^2]=0.
$$
よって
$$
